...
import { IonPage, IonHeader, IonToolbar, IonTitle, IonButtons, IonButton, IonIcon, IonContent, IonFab, IonFabButton, IonFabList } from '@ionic/vue'; import { add, cameraOutline, imagesOutline, informationCircleOutline, logOutOutline, serverOutline, trashOutline } from 'ionicons/icons';
